...
/* compiled from: DeviceRemoteControllerView2011.java */
...
public class l0 extends b1 {
    ...
    public class e implements View.OnClickListener {
        ...
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            l0.this.f.f770a.a(b.b.a.a.b.p.v.a.DIM, "DIM");
        }
    }
    ...
    public l0(Context context, b.b.a.a.b.p.d dVar) {
        super(context);
        this.e = dVar;
        this.f = new b.b.a.a.b.m.d(dVar);
        a(R.layout.layout_remote_device_2011);
    }
    ...
    public void b(View view) {
        ...
        a(R.id.setup_button, aVar.q, null, new c());
        a(R.id.display_button, aVar.s, null, new d());
        a(R.id.dimmer_button, true, null, new e());
        a(R.id.return_button, true, null, new f());
    }
}
