...
public class ActionBarContainer extends FrameLayout {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        return this.f652b || super.onInterceptTouchEvent(motionEvent);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!b(this.d)) {
            ...
            a2 = !b(this.e) ? a(this.e) : 0;
        }
        setMeasuredDimension(getMeasuredWidth(), Math.min(a(this.f653c) + a2, mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(i2) : Integer.MAX_VALUE));
    }
    ...
    public void setStackedBackground(Drawable drawable) {
        ...
        if (drawable != null) {
            ...
            if (this.j && (drawable2 = this.g) != null) {
                drawable2.setBounds(this.f653c.getLeft(), this.f653c.getTop(), this.f653c.getRight(), this.f653c.getBottom());
            }
        }
        boolean z = true;
        if (!this.i ? this.f != null || this.g != null : this.h != null) {
