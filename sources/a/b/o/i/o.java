...
public class o extends c implements Menu {
    public final a.e.g.a.a d;

    public o(Context context, a.e.g.a.a aVar) {
        super(context);
        if (aVar != null) {
            this.d = aVar;
            return;
    ...
    @Override // android.view.Menu
    public void clear() {
        Map<a.e.g.a.b, MenuItem> map = this.f111b;
        if (map != null) {
            map.clear();
        }
        Map<a.e.g.a.c, SubMenu> map2 = this.f112c;
        if (map2 != null) {
            map2.clear();
        }
        this.d.clear();
    ...
    public void removeGroup(int i) {
        Map<a.e.g.a.b, MenuItem> map = this.f111b;
        if (map != null) {
            Iterator<a.e.g.a.b> it = map.keySet().iterator();
            while (it.hasNext()) {
