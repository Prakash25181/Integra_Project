...
public abstract class a extends BaseAdapter implements Filterable, b.a {
    ...
    public class C0020a extends ContentObserver {
        ...
        public void onChange(boolean z) {
            Cursor cursor;
            a aVar = a.this;
            if (!aVar.f478c || (cursor = aVar.d) == null || cursor.isClosed()) {
                return;
            }
            aVar.f477b = aVar.d.requery();
        }
    }
    ...
    public a(Context context, Cursor cursor, boolean z) {
        ...
        if (z2) {
            C0020a c0020a = this.g;
            if (c0020a != null) {
                cursor.registerContentObserver(c0020a);
            }
    ...
    public int getCount() {
        Cursor cursor;
        if (!this.f477b || (cursor = this.d) == null) {
            return 0;
        }
    ...
    public long getItemId(int i) {
        Cursor cursor;
        if (this.f477b && (cursor = this.d) != null && cursor.moveToPosition(i)) {
