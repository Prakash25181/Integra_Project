...
public class b {
    ...
    public static void a(b[] bVarArr, Path path) {
        ...
        while (i4 < bVarArr2.length) {
            char c6 = bVarArr2[i4].f375a;
            float[] fArr3 = bVarArr2[i4].f376b;
            float f20 = fArr2[c4];
            float f21 = fArr2[1];
            float f22 = fArr2[2];
            float f23 = fArr2[3];
                ...
                if (c6 != 'A') {
                    if (c6 != 'C') {
                        if (c6 == 'H') {
                            ...
                            c2 = c6;
                            i3 = i4;
                            a(path, f45, f44, fArr3[i42] + f45, fArr3[i43] + f44, fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i2 + 2], fArr3[i2 + 3] != 0.0f, fArr3[i2 + 4] != 0.0f);
                            f28 = f45 + fArr[i42];
                            f29 = f44 + fArr[i43];
                        }
                        i5 = i2 + i;
    ...
    public b(b bVar) {
        ...
        float[] fArr = bVar.f376b;
        this.f376b = r.a(fArr, 0, fArr.length);
    }
