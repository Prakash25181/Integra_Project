...
public class f<K, V> {
    ...
    public final LinkedHashMap<K, V> f316a;
    ...
    public f(int i) {
        if (i > 0) {
            this.f318c = i;
            this.f316a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public final synchronized String toString() {
        int i;
        i = this.f + this.g;
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.f318c), Integer.valueOf(this.f), Integer.valueOf(this.g), Integer.valueOf(i != 0 ? (this.f * 100) / i : 0));
    }
    ...
    */
    public void a(int r3) {
        ...
        L0:
            monitor-enter(r2)
            int r0 = r2.f317b     // Catch: java.lang.Throwable -> L69
            if (r0 < 0) goto L4a
            java.util.LinkedHashMap<K, V> r0 = r2.f316a     // Catch: java.lang.Throwable -> L69
        ...
        L1e:
            ...
            int r0 = r2.f317b     // Catch: java.lang.Throwable -> L69
            int r0 = r0 + (-1)
            r2.f317b = r0     // Catch: java.lang.Throwable -> L69
