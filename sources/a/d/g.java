...
public abstract class g<K, V> {
    ...
    public g<K, V>.b f319a;

    /* renamed from: b, reason: collision with root package name */
    public g<K, V>.c f320b;

    /* renamed from: c, reason: collision with root package name */
    public g<K, V>.e f321c;
    ...
    public final class a<T> implements Iterator<T> {
        ...
        public boolean hasNext() {
            return this.d < this.f323c;
        }

        @Override // java.util.Iterator
        public T next() {
            if (hasNext()) {
                T t = (T) g.this.a(this.d, this.f322b);
                this.d++;
                this.e = true;
                return t;
            }
    ...
    public final class b implements Set<Map.Entry<K, V>> {
        ...
        public boolean contains(Object obj) {
            ...
            return a.d.d.a(g.this.a(a2, 1), entry.getValue());
        }
    ...
    public final class d implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public boolean equals(Object obj) {
            if (this.d) {
                ...
                Map.Entry entry = (Map.Entry) obj;
                return a.d.d.a(entry.getKey(), g.this.a(this.f327c, 0)) && a.d.d.a(entry.getValue(), g.this.a(this.f327c, 1));
            }
        ...
        public K getKey() {
            if (this.d) {
                return (K) g.this.a(this.f327c, 0);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        public V getValue() {
            if (this.d) {
                return (V) g.this.a(this.f327c, 1);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        @Override // java.util.Iterator
        public boolean hasNext() {
            return this.f327c < this.f326b;
        }

        @Override // java.util.Map.Entry
        public int hashCode() {
            if (this.d) {
                Object a2 = g.this.a(this.f327c, 0);
                Object a3 = g.this.a(this.f327c, 1);
        ...
        public V setValue(V v) {
            if (this.d) {
                return (V) g.this.a(this.f327c, (int) v);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
